...
export default function LoginMenu({ providers, callbackUrl }: LoginMenuProps) {
        ...
        <>
            ...
            <div className="flex gap-3 flex-col items-">
                <Button
                    ...
                    className="bg-blue-500 hover:bg-blue-500/90 active:bg-blue-500/80"
                >
                    <svg
                        className="mr-3"
